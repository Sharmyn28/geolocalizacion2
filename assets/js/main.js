function initMap() {
    ...
    var autocompleteOriginInput = new google.maps.places.Autocomplete(inputOrigen);
    autocompleteOriginInput.bindTo('bounds', map);
    var infoWindow = new google.maps.InfoWindow();
    var markerOrigen = crearMarcador(map);

    
    crearListener(autocompleteOriginInput, infoWindow, markerOrigen);*/
/*-------------*/
    ...
    /*function buscarMiUbicacion() {
        if(navigator.geolocation){
            navigator.geolocation.getCurrentPosition(drawCurrentPosition,funcionError);
        }
    }
    ...
    var drawCurrentPosition = function(posicion) {
        ...
        infoWindow.setContent('<div><strong>Mi ubicación actual</strong><br>');
